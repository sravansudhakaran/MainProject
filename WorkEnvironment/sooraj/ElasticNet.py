...
# Pipeline and Parameters - ElasticNet Regression
print("[>] Creating Pipeline ...")

pipe_elasnet= Pipeline([('scl', StandardScaler()),('clf', ElasticNet(max_iter=1500))])
param_elasnet = {'clf__alpha': [0.01, 0.1, 1, 10,0.02, 0.2, 2, 20,0.05, 0.5, 5, 50]}
...
model(pipe_elasnet, param_elasnet, X_train, y_train, X, y)
